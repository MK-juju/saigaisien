...
export default function Page() {
  ...
  return <main className={`app-shell ${chromeHidden?'chrome-hidden':''}`}>
    <header className="topbar">
      ...
      {/* 左上のブランドアイコンは、アプリの検索ホームへ戻る共通導線です。 */}<a href="/" className="brand" aria-label="よりそいホーム"><div className="brand-mark"><HeartHandshake size={22}/></div><div><strong>よりそい</strong><span>災害支援マッチング</span></div></a>
