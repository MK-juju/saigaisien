  ...
  return (
    <main className="home-page">
      ...
      <section className="home-hero">
        <div className="home-copy"><span className="eyebrow">災害時の物資支援を、もっと安全に</span><h1>必要な人と、<br /><em>支えたい人</em>をつなぐ。</h1><p>よりそいは、被災者の支援依頼と支援者の申し出を、災害時の安全情報に合わせてつなぐアプリです。</p><div className="home-actions"><Link href="/" className="primary-button">アプリを利用する <ArrowRight size={17} /></Link><Link href="/help" className="secondary-button"><LifeBuoy size={16} />使い方を見る</Link></div></div>
